...
def get_readable_time(seconds: int) -> str:
    ...
    return ping_time
PM_START_TEXT = """
`𝙷𝚎𝚕𝚕𝚘 {first} 😊` `𝙼𝚢 𝚗𝚊𝚖𝚎 𝚒𝚜` *All In One Robot*
`𝙸'𝚖 𝚑𝚎𝚛𝚎 𝚝𝚘 𝚑𝚎𝚕𝚙 𝚢𝚘𝚞 𝚖𝚊𝚗𝚊𝚐𝚎 𝚢𝚘𝚞𝚛 𝚐𝚛𝚘𝚞𝚙𝚜! 𝙷𝚒𝚝` *📚𝙲𝚘𝚖𝚖𝚊𝚗𝚍𝚜*   
"""
buttons = [
    [
        InlineKeyboardButton(
            text='Add Me Anywhere😇", url="t.me/SafeGroup_Protectionbot?startgroup=true"),
    ],
     [
        InlineKeyboardButton(text="𝐀𝐛𝐨𝐮𝐭💝", callback_data="evil_"),
        InlineKeyboardButton(
            text="Owner", url=f"https://t.me/jm867"
        ),
     ],
     [  
        InlineKeyboardButton(text="Support🛠", url="https://t.me/Jimi_Bots"),
        InlineKeyboardButton(text="Group", url="https://t.me//jimibots_grp"),
    ], 
...
def evil_about_callback(update, context):
    ...
    if query.data == "evil_":
        query.message.edit_text(
            text=""" ℹ️ I'm powerful and Advanced group management bot built to Manage your group easily.
                 ...
                 \n\n_My licensed under the GNU General Public License v3.0
                       """,
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
